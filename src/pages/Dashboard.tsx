...
export default function Dashboard() {
    const allResumesMockData = [
        ...
        },
        {
            ...
            updatedAt: "2025-09-20T16:50:00Z",
        },
    ]
    ...
    const loadAllResumes = async () => {
        setAllResumes(allResumesMockData)
    }
    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto px-4 py-8">
                <p className="text-2xl font-medium mb-6 bg-grandient-to-r from-slate-500 to-slate-700 bg-clip-text text-transparent sm:hidden">Welcome, Joe Doe</p>
                ...
                <div className="flex gap-4">
                    ...
                    <button className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hober:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <div className="grid grid-cols-2 sm:flex flex-wrap gap-4">
                    {allResumes.map((resume: any, index: number) => {
                        ...
                        return (
                            <button key={index} className="relative w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 border group group-hover:shadow-lg transition-all duration-300 cursor-pointer" style={{
