            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="fixed top-10 left-0 right-0 z-40 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm bg-white/80 backdrop-blur border-b border-slate-200">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        <a href="#" className="hover:text-purple-600 transition">{t('home')}</a>
                        <a href="#features" className="hover:text-purple-600 transition">{t('features')}</a>
                        <a href="#testimonials" className="hover:text-purple-600 transition">{t('testimonials')}</a>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <a href="#features" className="text-white">{t('features')}</a>
                    <a href="#testimonials" className="text-white">{t('testimonials')}</a>
                    <a href="#cta" className="text-white">{t('contact')}</a>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        {t('landYourDreamJobWithAIpowerdResumes')}
                    </h1>

                    <p className="max-w-md text-center text-base my-7">{t('createEditAndDownloadProfessinalResumesWithAIpoweredAssistance')}</p>
                    ...
                    <p className="py-6 text-slate-600 mt-14">{t('trustingByLeadingBrandsIncluding')}</p>
