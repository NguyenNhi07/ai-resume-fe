...
export const Hero = () => {
  ...
  // Fetch current user profile from API when logged in
  useEffect(() => {
    if (!isLoggedIn) {
      setUser(null);
      return;
        ...
        <nav className="fixed top-10 left-0 right-0 z-40 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm bg-white/80 backdrop-blur border-b border-slate-200">
          ...
          <div className="flex gap-2 items-center">
            ...
            >
              <div
                className={cn(
                  "px-4 py-3 flex items-center gap-2 h-full rounded-lg",
                )}
              >
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <div className="flex items-center mt-24">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">{t("usedBy10000Users")}</p>
            </div>
          </div>
          ...
          <p className="max-w-md text-center text-base my-7">
            {t(
              "createEditAndDownloadProfessinalResumesWithAIpoweredAssistance",
            )}
          </p>
          ...
          <p className="py-6 text-slate-600 mt-14">
            {t("trustingByLeadingBrandsIncluding")}
          </p>
        </div>
      </div>
      <style>
