...
export const MinimalImageTemplate = ({ data, accentColor }: { data: Resume, accentColor: string }) => {
            ...
            {data.professional_sumary && (
                <div className="mb-10">
                    <div className="flex items-center mb-4">
                        <div className="w-12 h-px mr-4" style={{ backgroundColor: accentColor }}></div>
                        <h2 className="text-lg font-medium text-gray-900 uppercase tracking-wide" style={{ color: accentColor }}>About</h2>
                    </div>
                ...
                <div className="space-y-10">
                    ...
                    {data.experience && data.experience.length > 0 && (
                        <div>
                            <div className="flex items-center mb-6">
                                <div className="w-12 h-px mr-4" style={{ backgroundColor: accentColor }}></div>
                                <h2 className="text-lg font-medium text-gray-900 uppercase tracking-wide" style={{ color: accentColor }}>Experience</h2>
                            </div>
                    ...
                    {data.education && data.education.length > 0 && (
                        <div>
                            <div className="flex items-center mb-6">
                                <div className="w-12 h-px mr-4" style={{ backgroundColor: accentColor }}></div>
                                <h2 className="text-lg font-medium text-gray-900 uppercase tracking-wide" style={{ color: accentColor }}>Education</h2>
                            </div>
                            <div className="space-y-4">
                                {data.education.map((edu, index) => (
                                    <div key={index} className="border-l-2 pl-4" style={{ borderColor: accentColor + '50' }}>
                ...
                <div className="space-y-10">
                    ...
                    {data.skills && data.skills.length > 0 && (
                        <div>
                            <div className="flex items-center mb-6">
                                <div className="w-12 h-px mr-4" style={{ backgroundColor: accentColor }}></div>
                                <h2 className="text-lg font-medium text-gray-900 uppercase tracking-wide" style={{ color: accentColor }}>Skills</h2>
                            </div>
                    ...
                    {data.project && data.project.length > 0 && (
                        <div>
                            <div className="flex items-center mb-6">
                                <div className="w-12 h-px mr-4" style={{ backgroundColor: accentColor }}></div>
                                <h2 className="text-lg font-medium text-gray-900 uppercase tracking-wide" style={{ color: accentColor }}>Projects</h2>
                            </div>
                            <div className="space-y-4">
                                {data.project.map((project, index) => (
                                    <div key={index} className="border rounded-lg p-4" style={{ borderColor: accentColor + '30' }}>
                                        <h3 className="font-medium text-gray-900 mb-2">{project.name}</h3>
                                        {project.description && (
                                            <p className="text-sm text-gray-700 leading-relaxed font-light mb-3">{project.description}</p>
                                        )}
                                        {project.technologies && project.technologies.length > 0 && (
                                            <div className="flex flex-wrap gap-2">
                                                {project.technologies.map((tech, techIndex) => (
                                                    <span key={techIndex} className="text-xs px-2 py-1 rounded-full font-medium" style={{ backgroundColor: accentColor + '20', color: accentColor }}>
                                                        {tech}
                                                    </span>
                                                ))}
                                            </div>
